                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tgl_lahir" class="form-control" id="datepicker" placeholder="Pilih Tanggal" autocomplete="off" value="<?php echo set_value('tgl_lahir', $tgl_lahir); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-goup">
                        ...
                        <div class="row p-t-25">
                            <div class="col-md-6">
                                <div class="form-goup">
                                    ...
                                    <input type="text" name="kecamatan" class="form-control" placeholder="Masukkan Kecamatan" autocomplete="off" value="<?php echo set_value('kecamatan', $kecamatan); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-goup">
                                    <label class="control-label">*Kabupaten/Kota</label>
                                    <input type="text" name="kab_kota" class="form-control" placeholder="Masukkan Kabupaten/Kota" autocomplete="off" value="<?php echo set_value('kab_kota', $kab_kota); ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row p-t-25">
                            <div class="col-md-6">
                                <div class="form-goup">
                                    ...
                                    <input type="text" name="provinsi" class="form-control" placeholder="Masukkan Provinsi" autocomplete="off" value="<?php echo set_value('provinsi', $provinsi); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-goup">
                        ...
                        <div class="row p-t-25">
                            ...
                            <div class="col-md-6">
                                <div class="form-goup">
                                    ...
                                    <input type="text" name="tgl_berlaku" id="dateRange" class="form-control" placeholder="Pilih Tanggal Mulai Berlaku" autocomplete="off" value="<?php echo set_value('tgl_berlaku', $tgl_berlaku); ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row p-t-25">
                            ...
                            <div class="col-md-6">
                                <div class="form-goup">
                                    ...
                                    <input type="text" name="kepala_desa" class="form-control" placeholder="Masukkan Nama Kepala Desa" autocomplete="off" value="<?php echo set_value('kepala_desa', $kepala_desa); ?>" required>
                                </div>
                            </div>
                        </div>
                        <!-- End of Form Body -->
